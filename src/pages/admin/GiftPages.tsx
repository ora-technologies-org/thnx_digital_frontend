...
const LoadingSpinner = () => (
  <div className="flex justify-center items-center min-h-[400px]">
    <motion.div
      className="w-16 h-16 border-4 border-purple-100 border-t-purple-600 rounded-full"
      animate={{ rotate: 360 }}
...
const MerchantCard = ({ merchant, onClick }) => {
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className="bg-white rounded-xl p-6 cursor-pointer border border-gray-200 hover:border-purple-300 transition-all"
    >
      {/* Header */}
      <div className="flex items-center gap-4 mb-4">
        <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg">
          {initial}
        </div>
      ...
      <div className="flex items-center justify-between pt-4 border-t border-gray-100">
        ...
        <button className="px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-sm font-medium rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all">
          View Cards →
        </button>
      </div>
    </motion.div>
    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <label className="font-medium text-gray-700">Filter by Price:</label>
          <select
            value={priceFilter}
