...
//                 <div className="w-32 h-32 bg-gradient-to-r from-orange-100 to-pink-100 rounded-3xl flex items-center justify-center mx-auto mb-6">
...
//                   Click the button below to start scanning customer gift card QR codes
//                 </p>
//                 <MagneticButton
//                   variant="primary"
//                   size="lg"
...
//                 <div className="bg-gray-900 rounded-2xl aspect-square max-w-md mx-auto mb-6 flex items-center justify-center">
//                   <div className="text-center">
//                     <Camera className="w-16 h-16 text-white mb-4 mx-auto animate-pulse" />
...
// // src/pages/merchant/ScanPage.tsx - QR SCANNER WITH VERIFICATION! 📱
// import React, { useState } from 'react';
// import { motion, AnimatePresence } from 'framer-motion';
// import { 
//   QrCode, Camera, CheckCircle, XCircle, User, 
//   Mail, Phone, Gift, DollarSign, Calendar, CreditCard,
...
// import type { PurchaseVerification } from '../../features/orders/types/order.types';
...
//     try {
//       const result = await ordersApi.verifyPurchase(qrCode.trim());
...
//     if (!verification?.purchase?.id) return;

//     if (!window.confirm('Mark this purchase as redeemed?')) return;

//     setIsRedeeming(true);

//     try {
//       await ordersApi.redeemPurchase(verification.purchase.id);
      
//       // Refresh verification
//       const result = await ordersApi.verifyPurchase(qrCode.trim());
//       setVerification(result);
      
//       alert('Purchase redeemed successfully!');
//     } catch (error) {
...
//           </h1>
//           <p className="text-gray-600">
//             Verify and redeem gift card purchases by scanning QR codes
//           </p>
//         </motion.div>
...
//                 <div className="w-24 h-24 bg-gradient-to-r from-orange-100 to-pink-100 rounded-3xl flex items-center justify-center mx-auto mb-4">
...
//                 </h3>
//                 <p className="text-gray-600">
//                   Enter or scan the gift card QR code to verify purchase
//                 </p>
//               </div>
...
//                 <Input
//                   label="QR Code"
//                   placeholder="e.g., THNX-DIGITAL-MI7DLDHC-FE4C3267AB391E80"
//                   value={qrCode}
...
//                 exit={{ opacity: 0, y: -20 }}
//               >
//                 {verification.isValid && verification.purchase ? (
//                   // Success - Valid Purchase
...
//                           This gift card purchase has been verified
//                         </p>
//                       </div>
//                       <div>
//                         {verification.purchase.isRedeemed ? (
...
//                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white rounded-lg p-6 mb-6">
...
//                                 {verification.purchase.customerName}
//                               </p>
//                             </div>
//                           </div>
//                           <div className="flex items-center gap-3">
...
//                               <a
//                                 href={`mailto:${verification.purchase.customerEmail}`}
//                                 className="font-semibold text-blue-600 hover:underline"
//                               >
//                                 {verification.purchase.customerEmail}
//                               </a>
//                             </div>
//                           </div>
//                           <div className="flex items-center gap-3">
...
//                               <a
//                                 href={`tel:${verification.purchase.customerPhone}`}
//                                 className="font-semibold text-blue-600 hover:underline"
//                               >
//                                 {verification.purchase.customerPhone}
//                               </a>
//                             </div>
//                           </div>
//                         </div>
...
//                               <p className="font-semibold text-gray-900">
//                                 {verification.purchase.giftCard.title}
//                               </p>
//                             </div>
//                           </div>
//                           <div className="flex items-center gap-3">
...
//                               <p className="font-semibold text-gray-900">
//                                 ₹{parseFloat(verification.purchase.amount).toFixed(2)}
//                               </p>
//                             </div>
//                           </div>
//                           <div className="flex items-center gap-3">
...
//                               <p className="font-semibold text-gray-900">
//                                 {verification.purchase.paymentMethod}
//                               </p>
//                             </div>
//                           </div>
//                         </div>
...
//                             {verification.purchase.code}
//                           </code>
//                         </div>
//                         <div>
//                           <p className="text-sm text-gray-500">Transaction ID</p>
//                           <code className="text-xs font-mono bg-gray-100 px-2 py-1 rounded">
//                             {verification.purchase.transactionId}
//                           </code>
//                         </div>
//                         <div>
//                           <p className="text-sm text-gray-500">Purchase Date</p>
//                           <p className="text-sm font-medium text-gray-900">
//                             {new Date(verification.purchase.createdAt).toLocaleString()}
//                           </p>
//                         </div>
//                         {verification.purchase.redeemedAt && (
//                           <div>
//                             <p className="text-sm text-gray-500">Redeemed Date</p>
//                             <p className="text-sm font-medium text-gray-900">
//                               {new Date(verification.purchase.redeemedAt).toLocaleString()}
//                             </p>
//                           </div>
//                         )}
//                       </div>
...
//                           {verification.error || 'This QR code could not be verified'}
//                         </p>
...
//                                 <li>QR code is incorrect or invalid</li>
//                                 <li>Purchase does not exist</li>
...
import { motion, AnimatePresence } from 'framer-motion';
import { 
  QrCode, CheckCircle, AlertCircle, DollarSign,
  MapPin, FileText, User, Mail, Phone, Store,
