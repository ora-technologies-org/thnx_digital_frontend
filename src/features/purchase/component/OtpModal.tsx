...
import { Shield, Clock, AlertCircle, Receipt } from "lucide-react";
...
export const OTPModal: React.FC<OTPModalProps> = ({
  ...
  const handleFinalSubmit = async () => {
    ...
    // Call the parent's redemption handler and wait for it to complete
    await onOTPVerified(amount, locationName, locationAddress, notes);

    // After redemption is complete, close OTP modal
    handleClose();
      ...
      >
        <div className="text-center py-4">
          ...
          <p className="text-gray-600 mb-6">
            Your points have been redeemed successfully. The transaction has
            been completed.
          </p>
          <Button
