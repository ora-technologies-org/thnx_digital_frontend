...
import { CheckCircle, Download, Mail, Printer, QrCode } from 'lucide-react';
...
interface PurchaseSuccessModalProps {
  isOpen: boolean;
  onClose: () => void;
  purchase: any; // Purchase response from API
  giftCard: GiftCard;
}
...
Present this QR code at the store to redeem your gift card.
    ...
    a.href = url;
    a.download = `thnx-digital-${qrCode}.txt`;
    a.click();
  };
      ...
      <div className="text-center space-y-6">
        ...
        <div className="bg-gradient-to-br from-orange-50 to-pink-50 rounded-2xl p-8 border-2 border-orange-200">
          ...
          <p className="text-sm text-gray-700">
            <strong>Save this QR code!</strong> Present it at the store to redeem your gift card.
          </p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-800">
            ...
            <br />
            A copy of your gift card and QR code has been sent to your email address.
          </p>
        </div>
